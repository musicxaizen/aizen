...
from configuration import filter_users, adminlist


@app.on_message(filters.command("auth") & filters.group & ~filter_users)
@AdminActual
...
@app.on_message(filters.command("unauth") & filters.group & ~filter_users)
@AdminActual
...
@app.on_message(
    filters.command(["authlist", "authusers"]) & filters.group & ~filter_users
)
@language

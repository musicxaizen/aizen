...
# ------------------------------------------
@devine.on_message(filters.command("get_sticker"))
@capture_err
async def sticker_image(_, message: Message):
    ...
    os.remove(f)
#----------------
@devine.on_message(filters.command("kang"))
@capture_err
async def kang(client, message: Message):
    ...
    try:
        if message.reply_to_message.sticker:
            ...
            temp_file_path = await devine.download_media(doc)
            ...
            try:
                ...
                await msg.edit_text("Something wrong hdevineened.")
                raise Exception(

...
@app.on_message(filters.command(["lang", "setlang", "language"]) & ~filter_users)
@language
...
@app.on_callback_query(filters.regex("LG") & ~filter_users)
@languageCB
...
@app.on_callback_query(filters.regex(r"languages:(.*?)") & ~filter_users)
@ActualAdminCB

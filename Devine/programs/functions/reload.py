...
from configuration import filter_users, adminlist, lyrical

rel = {}


@app.on_message(
    filters.command(["admincache", "reload", "refresh"]) & filters.group & ~filter_users
)
@language
...
@app.on_message(filters.command(["reboot"]) & filters.group & ~filter_users)
@AdminActual
...
@app.on_callback_query(filters.regex("close") & ~filter_users)
...
@app.on_callback_query(filters.regex("stop_downloading") & ~filter_users)
@ActualAdminCB

...
@app.on_message(
    filters.command(["settings", "setting"]) & filters.group & ~filter_users
)
@language
...
@app.on_callback_query(filters.regex("settings_helper") & ~filter_users)
@languageCB
...
@app.on_callback_query(filters.regex("settingsback_helper") & ~filter_users)
@languageCB
...
@app.on_callback_query(filters.regex("FERRARIUDTI") & ~filter_users)
@ActualAdminCB
...
@app.on_callback_query(filters.regex(pattern=r"^(AUTH|AUTHLIST)$") & ~filter_users)
@ActualAdminCB
...
@app.on_callback_query(filters.regex("VOMODECHANGE") & ~filter_users)
@ActualAdminCB
